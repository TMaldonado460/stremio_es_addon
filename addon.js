// Addon privado: catalogos + busqueda + metadatos en espanol.
// Fuente: TMDB (es-MX > es-ES > en-US) + Trakt (tendencias).
// Los ids emitidos son IMDb (tt...) para que Torrentio / MediaFusion /
// el addon oficial de TorBox sigan resolviendo streams sin cambios.
const { addonBuilder, serveHTTP } = require('stremio-addon-sdk');
const { readEnv, resolveTokens, hasTmdb } = require('./lib/config');
