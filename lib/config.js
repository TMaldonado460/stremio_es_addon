...
function readEnv() {
  return {
    ...
    ttlSearch: parseInt(process.env.CACHE_TTL_SEARCH || '3600', 10),
    ttlCatalog: parseInt(process.env.CACHE_TTL_CATALOG || `${6 * 3600}`, 10),
    ttlMeta: parseInt(process.env.CACHE_TTL_META || `${24 * 3600}`, 10),
    ttlTrakt: parseInt(process.env.CACHE_TTL_TRAKT || `${6 * 3600}`, 10),
  };
}
